...
test("offline changelog covers every shipped version without duplicates", () => {
  ...
  assert.deepEqual(versions.map(item => item.versionName), ["2.1.3", "2.1.2", "2.1.1", "2.1.0", "2.0.1", "2.0.0", "1.9.2", "1.9.1", "1.9.0", "1.8.0", "1.7.0", "1.6.0", "1.5.0", "1.4.2", "1.4.1", "1.4.0", "1.3.0", "1.2.0", "1.1.0", "1.0.0"]);
